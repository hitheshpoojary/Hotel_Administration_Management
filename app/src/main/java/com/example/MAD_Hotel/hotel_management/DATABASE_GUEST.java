...
public class DATABASE_GUEST extends SQLiteOpenHelper {
    ...
    public static final String col7_name="Email";
    public static final String col8_name="Aadhar_no";
...
//creating table
        db.execSQL("create table "+table_name+"(Guest_ID INTEGER PRIMARY KEY AUTOINCREMENT,Guest_Name Text,G_mobile_no integer,Check_in_date integer,Check_out_date integer,Room_no Integer,Room_type Text,Email Text,Aadhar_no Text )");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS "+table_name); //deleting the table
        onCreate(db);

    }
    public  boolean insertData(String Guest_Name,String G_mobile_no,String Check_in_date,String Check_out_date,String Room_no,String Room_type,String Email,String Aadhar_no)
    {  //inserting guest information
        ...
        contentValues.put(col7_name,Email);
        contentValues.put(col8_name,Aadhar_no);
    ...
    public boolean updatedata(String Guest_Name,String G_mobile_no,String Check_in_date,String Check_out_date,String Room_no,String Room_type,String Email,String Aadhar_no)
